 ...
 * On top of that calculates the kilometers that needs to be ran to
 * burn that amount calories 
 *
 */
...
public class Lab01_Q3_Revision {
    ...
    public static void main(String[] args) {
        ...
        // Calorie burned from running per kilometer
        final int calorieBurntPerKm = 70;
        ...
        double kmsNeededToRun = dailyCalorieDeficit / calorieBurntPerKm;
        ...
        String kmsNeededToRunFormatted =  String.format("%.1f", kmsNeededToRun);
        System.out.println("To achieve this deficit via exercise you need to run " + kmsNeededToRunFormatted + " kilometers per day");
